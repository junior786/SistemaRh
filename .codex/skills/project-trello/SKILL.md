...
5. Keep descriptions compact and execution-oriented:
   - objective
   - scope
   - constraints or dependencies
   - reference docs when relevant
6. When the request changes many cards at once, summarize the intended grouping first in a short commentary update, then apply the changes.
